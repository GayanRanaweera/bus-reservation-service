...
public class RequestBuilder {
     ...
     */
    public static ReservationRequest buildReservationRequest(HttpServletRequest request)
        ...
        try {
            reservationRequest = gson.fromJson(request.getReader(), ReservationRequest.class);
